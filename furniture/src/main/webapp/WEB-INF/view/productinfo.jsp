...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<p style="float: left;">
				You have choosen <%=request.getParameter("catg")%>
				Albums
			</p>
		...
		<img width=200 height="200" src="resources/images/<%=request.getParameter("catg")%>.jpg"/><span></span>	<form>
